...
public class DsXmlWriter extends AbstractDsWriter {

	private boolean formatContent = true;
	private int depth = 0;
	private boolean lastDirectiveOpen = false;

	public DsXmlWriter(OutputStream outputStream) {
		super(outputStream);
		this.format = "XML";
	}
	...
	public void onDocumentStart(DsModel dsModel) throws Exception {
	...
	public String[] onRecordStart(DsModel dsModel) throws Exception {
		this.closeDirective();
		String path = dsModel.getPath();
		if (!StringUtils.isEmpty(path)) {
			String[] parts = path.split("\\.");
	...
	public void onItemStart(MDs_Item crtItem, MDs_Item prevItem) throws Exception {
		if (crtItem == null) {
			return;
		}
	...
	public void onDocumentEnd(DsModel dmModel) throws Exception {
	...
	public void onItemEnd(MDs_Item crtItem, MDs_Item nextItem) throws Exception {
		if (crtItem == null) {
			return;
		}
...
//	public String[] beginRecord(MDs_List ds) throws Exception {
//		this.closeDirective();
...
//	public String[] beginItem(MDs_Item item) throws Exception {
//
...
//	public void value(MDs_Item item, ResultSet rs) throws Exception {
